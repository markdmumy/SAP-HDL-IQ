drop procedure if exists sp_hdl_unload_table2
go

create procedure sp_hdl_unload_table2 (
...
UNLOAD FROM TABLE '||tbl_owner||'.'||tbl_name||' INTO FILE 's3://my_S3_data/Q3results^.gz'
...
MAX FILE SIZE 51200;
	...
	if lower( unload_compressed ) = 'gz' or lower( unload_compressed ) = 'compress' or lower( unload_compressed ) = 'compressed'
        ...
        execute immediate 'SET TEMPORARY OPTION TEMP_EXTRACT_MAX_PARALLEL_DEGREE = ''1000''';
